...
#### **a** (Helidon Níma is the first Java microservices framework based on virtual threads.)
...
- [Creating a Reactive CRUD blog app with MongoDB, Quarkus and Panache](https://medium.com/geekculture/creating-a-reactive-crud-blog-app-with-mongodb-quarkus-and-panache-54d659cf8dcb)
  - [dvddhln/quarkus-crud-reactive-mongodb](https://github.com/dvddhln/quarkus-crud-reactive-mongodb)
